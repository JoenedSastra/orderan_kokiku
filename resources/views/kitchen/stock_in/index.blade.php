...
<div class="mb-3 kk-page-header d-flex justify-content-between align-items-center flex-wrap gap-2">
    ...
    <div class="d-flex align-items-center gap-2 flex-nowrap">
        <form action="{{ route('kitchen.stock_in.index') }}" method="GET" class="m-0">
        ...
        <table class="table table-hover mb-0 text-center">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <form action="{{ route('kitchen.stock_in.destroy', $s->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Apakah Anda yakin ingin menghapus riwayat barang masuk ini?');">
                            @csrf
                            @method('DELETE')
            ...
            <form action="{{ route('kitchen.stock.adjust') }}" method="POST">
                ...
                <div class="modal-header border-0 pb-0" style="background:linear-gradient(135deg,#0ea5e9 0%,#0284c7 100%);padding:1.4rem 1.5rem 2.5rem;">
                    <div>
                        ...
                        <small style="color:rgba(255,255,255,.75);font-size:.78rem;">Penyesuaian stok manual secara massal untuk Kitchen</small>
                    </div>
                </div>
