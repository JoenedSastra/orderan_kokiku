...
<a href="{{ route('kasir.dashboard') }}" class="kk-devisi-link {{ request()->routeIs('kasir.dashboard') ? 'active' : '' }}" style="--accent-color:#6366f1; --icon-glow:rgba(99,102,241,0.45);">
...
<a href="{{ route('kasir.stock_in.index') }}" class="kk-devisi-link {{ request()->routeIs('kasir.stock_in.*') ? 'active' : '' }}" style="--accent-color:#38bdf8; --icon-glow:rgba(56,189,248,0.45);">
...
<a href="{{ route('kasir.stock_out.index') }}" class="kk-devisi-link {{ request()->routeIs('kasir.stock_out.*') ? 'active' : '' }}" style="--accent-color:#f43f5e; --icon-glow:rgba(244,63,94,0.45);">
...
<a href="{{ route('kasir.stock_harian.index') }}" class="kk-devisi-link {{ request()->routeIs('kasir.stock_harian.*') ? 'active' : '' }}" style="--accent-color:#10b981; --icon-glow:rgba(16,185,129,0.45);">
...
<a href="{{ route('kasir.orders.create') }}" class="kk-devisi-link {{ request()->routeIs('kasir.orders.create') ? 'active' : '' }}" style="--accent-color:#f59e0b; --icon-glow:rgba(245,158,11,0.45);">
