...
<div class="kk-stat-card">
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <a href="{{ route('kasir.orders.index') }}" class="btn btn-sm btn-outline-secondary">Lihat Semua</a>
    </div>
    @if($ordersRecent->isEmpty())
        <p class="text-muted mb-0" style="font-size:0.88rem;">Belum ada permintaan. <a href="{{ route('kasir.orders.create') }}">Buat Permintaan</a></p>
    @else
