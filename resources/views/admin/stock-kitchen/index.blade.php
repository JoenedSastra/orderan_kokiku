@extends('layouts.app')
@section('title', 'Stock Kitchen Harian')
@section('content')
<div class="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-2">
    <div>
        <h2 class="h5 mb-0">Stock Kitchen Harian</h2>
        <p class="text-muted mb-0" style="font-size:0.82rem;">Rekap otomatis dari transaksi Barang Masuk &amp; Keluar Kitchen (Sayur, Daging, Saos).</p>
    </div>
