...
<div class="d-flex justify-content-between align-items-center mb-3 kk-page-header flex-wrap gap-2">
    <div>
        ...
        <p class="text-muted small mb-0">Pilih divisi tujuan, lalu isi tabel barang masuk secara massal seperti Excel.</p>
    </div>
    <a href="{{ route('admin.stock_in.riwayat') }}" class="btn btn-sm btn-outline-secondary">
