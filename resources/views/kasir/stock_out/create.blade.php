...
<div class="kk-stat-card" style="max-width:520px">
    ...
    <form action="{{ route('kasir.stock_out.store') }}" method="POST">
        @csrf
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="keterangan" class="form-control" value="{{ old('keterangan') }}" placeholder="Digunakan, Dijual, dll">
        </div>
