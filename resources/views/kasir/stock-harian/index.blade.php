        ...
        <table class="table table-hover mb-0 text-center align-middle table-sm">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center text-danger fw-semibold align-middle">{{ $item->keluarByLocation($item->master_location) }} {{ $item->kasir_keluar_unit ?? $item->kasir_unit ?? $item->unit }}</td>
                    <td class="text-center text-primary fw-bold align-middle">{{ $item->stokByLocation($item->master_location) }} {{ $item->kasir_unit ?? $item->unit }}</td>
                    ...
                    <td class="text-center align-middle">
                        <span class="badge" style="background:#bbf7d0;color:#15803d;font-weight:600;">Staff Kasir</span>
                    </td>
                </tr>
                @empty
